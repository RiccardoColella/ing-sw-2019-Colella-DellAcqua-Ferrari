...
class BoardTest {
    ...
    void getRoom() {
        ...
        //Building the expected result
        block_1_2_1.ifPresent(roomWhite10::add);
        block_1_2_2.ifPresent(roomWhite10::add);
        //trying to select a room of 2 blocks passing one block
        block_1_2_2.ifPresent(block -> assertEquals(roomWhite10, board1.getRoom(Objects.requireNonNull(block)), "1. Error in getting white room in BOARD 10 part1of2."));
        //trying to select the room of 2 blocks passing the other block
        block_1_2_1.ifPresent(block -> assertEquals(roomWhite10, board1.getRoom(block), "2. Error in getting white room in BOARD 10 part2of2."));
        ...
        block_2_0_3.ifPresent(roomGreen11a::add);
        block_2_0_3.ifPresent(block -> assertEquals(roomGreen11a, board2.getRoom(block), "3. Error in getting green room in BOARD_2."));
        ...
        block_2_1_2.ifPresent(roomYellow11a::add);
        block_2_1_3.ifPresent(roomYellow11a::add);
        block_2_2_2.ifPresent(roomYellow11a::add);
        block_2_2_3.ifPresent(roomYellow11a::add);
        //Testing a more complex room
        block_2_1_2.ifPresent(block -> assertEquals(roomYellow11a, board2.getRoom(block), "4. Error in getting yellow room in BOARD_2."));
    }
    ...
    void teleportPlayer() {
        ...
        block_12_2_2.ifPresent(block -> block.addPlayer(players.get(i)));
        //Executing teleportPlayer
        block_12_0_0.ifPresent(destinationBlock -> board4.teleportPlayer(players.get(i), destinationBlock));
        //Checking result
        ...
        block_12_2_2.ifPresent(block -> block.addPlayer(players.get(k)));
        //Executing teleportPlayer
        block_12_2_2.ifPresent(destinationBlock -> board4.teleportPlayer(players.get(i), destinationBlock));
        //Checking result
        ...
        assertTrue(block_12_0_0.isPresent());
        assertThrows(NullPointerException.class, () -> board4.teleportPlayer(players.get(j), block_12_0_0.get()));
        //Cleaning scenario
        block_12_2_2.ifPresent(block -> block.removePlayer(players.get(i)));
        block_12_2_2.ifPresent(block -> block.removePlayer(players.get(k)));
    }
}